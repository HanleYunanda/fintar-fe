...
export const routes: Routes = [
  ...
  },
  {
    path: 'unauthorized',
    loadComponent: () =>
      import('./features/error/unauthorized/unauthorized').then((m) => m.UnauthorizedComponent),
  },
  {
    path: '',
    ...
    children: [
      ...
      },
      {
        path: 'permission',
        loadComponent: () =>
          import('./features/permission/permission').then((m) => m.PermissionComponent),
        canActivate: [permissionGuard],
        ...
        children: [
          {
            path: '',
            loadComponent: () =>
              import('./features/loan/loan-list/loan-list').then((m) => m.LoanListComponent),
          },
          {
            path: 'report',
            loadComponent: () =>
              import('./features/report/report-dashboard/report-dashboard').then(
          ...
          },
          {
            path: ':id',
            loadComponent: () =>
              import('./features/loan/loan-detail/loan-detail').then((m) => m.LoanDetailComponent),
          },
        ],
      },
      {
